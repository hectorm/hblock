...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/hectorm/hblock/v1.6.2/hblock' \
  && echo '71d67578b9107979d16967b14106a97e8adb318c2a654a76ff7e8d8039edbaf0  /tmp/hblock' | shasum -c \
