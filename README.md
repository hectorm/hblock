...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/hectorm/hblock/v1.6.1/hblock' \
  && echo '683ba02d40747f855ee01f51189c9e2d8a8617814c3272936c15efb85304ff35  /tmp/hblock' | shasum -c \
