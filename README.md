...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/zant95/hblock/v1.3.1/hblock' \
  && echo 'a3e12f55d9a533a0dea61a62bd8e9a63aca31aafe955af4bea4fe4eac659933a  /tmp/hblock' | shasum -c \
