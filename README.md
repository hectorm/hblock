...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/hectorm/hblock/v2.0.7/hblock' \
  && echo 'f9c129295bf60ec2582ecac87571d67ffcef89b17f2d01ed9954ae500152afbc  /tmp/hblock' | shasum -c \
