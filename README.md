...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/zant95/hblock/v1.5.0/hblock' \
  && echo 'bfe404a721aa8c5481dc2723e00d7f3409555517859a36dd76a1bb66b7e4927b  /tmp/hblock' | shasum -c \
