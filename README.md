...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/hectorm/hblock/v1.6.0/hblock' \
  && echo 'afc451a42a7494d229db4ed9da44baa56350ce14e7fa4f4ffb7af94f5454c967  /tmp/hblock' | shasum -c \
