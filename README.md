...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/zant95/hblock/v1.3.4/hblock' \
  && echo 'a432b4ef3bffb2d19cdf8aad0c6d3e6dcd43d4595ce31e062b4ed00d4da76701  /tmp/hblock' | shasum -c \
