...
```sh
curl -o /tmp/hblock 'https://raw.githubusercontent.com/hectorm/hblock/v1.6.5/hblock' \
  && echo 'a114e9138dfb54347d3234dcef84574300b6bae82624bfa34e2715635924606a  /tmp/hblock' | shasum -c \
